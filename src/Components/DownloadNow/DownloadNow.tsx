  ...
  return (
    <section className="w-full bg-[#010314] flex flex-col items-center justify-center">
      ...
      <div className="w-[90%] h-[550px] bg-[url('/download1.webp')] bg-cover bg-center rounded-2xl shadow-lg flex relative my-8">
        {/* Left Section */}
        <div className="w-1/2 h-full flex flex-col justify-center px-8 z-10 text-white">
          <button className="text-white border border-white px-6 py-2 rounded-full mb-4 w-max">
            {down.title}
          </button>
          <h2 className="text-4xl font-bold leading-tight p-2 w-max text-white rounded-md mb-4">
            {down.subtitle}
          </h2>
        ...
        {/* Right Section */}
        <div className="w-1/2 h-full flex justify-center items-end z-10">
          <Image
            src={down.heroImg}
            alt="User with phone"
            width={300}
      ...
      <div className="w-[85%] flex items-center justify-between bg-[#010314] mt-10 py-8 px-4 text-white">
        <div className="mb-6 text-center">
          <div className="border border-white text-white px-4 py-1 rounded-full text-sm w-max mb-3">
            Payment Methods
          </div>
          <h2 className="text-3xl font-bold">We accept</h2>
        </div>
        <div className="flex flex-wrap justify-center gap-4">
          {img.map((card, idx) => (
            <div className="w-fit px-[10px] py-[5px] bg-[#0E1020] rounded-[10px]">
              <Image
                key={idx}
                src={card}
