...
export default function Server(){
    return(
        <section className="h-[500px] w-full flex justify-center items-center bg-[#010314]">
            <div className="w-[85%] h-[70%] flex justify-center gap-[20px] items-center ">
                {/* left-container */}
                ...
                {/* right-container */}
                <div className="h-full w-[48%] flex flex-col justify-center gap-[4px] text-white ">
